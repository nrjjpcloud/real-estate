...
//radio button catagory -steps

function toggleCategory(type) {
   const residential = document.getElementById('residentialCategories');
   const commercial = document.getElementById('commercialCategories');
      ...
      navigator.geolocation.getCurrentPosition(
         (position) => {
            ...
            document.getElementById(
               'locationResult'
            ).innerHTML = `🌍 Latitude: <strong>${latitude}</strong> <br> 🌍 Longitude: <strong>${longitude}</strong>`;
         },
         (error) => {
